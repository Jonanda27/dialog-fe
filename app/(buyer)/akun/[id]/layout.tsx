    ...
    return (
        <div className="max-w-7xl mx-auto px-6 py-10">
            <div className="flex flex-col lg:flex-row gap-10">
                ...
                {/* CONTENT AREA (KANAN) */}
                <main className="flex-1 bg-[#111114] border border-zinc-800 rounded-[2.5rem] p-8 lg:p-12 shadow-2xl">
                    {children}
                </main>
            </div>
        </div>
