...
import { useAuthStore } from "@/store/authStore"; // Proteksi Login
...
import AuctionBidPanel from "@/components/product/AuctionBidPanel"; // Ditambahkan agar mode lelang tidak error
...
export default function ProductDetailPage() {
  ...
  // STATE: Mempertahankan Product murni dengan any fallback untuk properti lelang sementara
            ...
            <div className="bg-amber-500/5 border border-amber-500/20 rounded-3xl p-6 flex items-start gap-4 shadow-inner">
              ...
              <div className="flex-1">
                ...
                <button
                  ...
                  className="mt-4 text-[10px] font-black text-amber-500 uppercase tracking-widest flex items-center gap-2 hover:text-amber-400 transition-colors disabled:opacity-50 cursor-pointer"
                >
