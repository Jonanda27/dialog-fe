...
export default function BuyerNavbar() {
  ...
  return (
    <header className="fixed top-0 w-full z-[100] transition-all duration-500">
      ...
      <div className="bg-[#0a0a0b] border-b border-zinc-900/50 py-2.5 px-6 hidden lg:block">
        <div className="w-full flex justify-between items-center text-[10px] font-black uppercase tracking-[0.15em]">
          <div className="flex items-center gap-8">
            ...
            <Link
              href="/sell"
              className="text-[#ef3333] hover:text-red-400 transition-colors flex items-center gap-1.5"
            >
      ...
      <div
        className={`transition-all duration-500 px-6 ${scrolled ? "bg-[#111114]/95 backdrop-blur-md py-4 shadow-2xl" : "bg-[#0a0a0b] py-6"}`}
      >
        <div className="w-full flex items-center justify-between gap-12">
          <Link
            href="/dashboard"
            className="text-3xl font-black text-[#ef3333] tracking-tighter uppercase shrink-0"
          >
          ...
          <div className="flex items-center gap-8 shrink-0">
                ...
                <div className="space-y-5">
                  ...
                  {items.length > 0 ? (
                    <>
                        ...
                        {recentItems.map((item) => (
                          ...
                          >
                              ...
                              <img
                                ...
                                onError={(e) => {
                                  (e.target as HTMLImageElement).src =
                                    "https://placehold.co/400x400?text=Error+Load";
                                }}
                              />
                            </div>

                            <div className="flex-1 min-w-0 pr-4">
                              <h5 className="text-[12px] font-black text-white uppercase truncate tracking-tight mb-1">
                                {item.product.name}
                              </h5>
                            ...
                            <div className="shrink-0 text-right">
                              <p className="text-[12px] font-black text-[#ef3333] italic">
                                Rp{" "}
                      ...
                      <Link
                        href="/cart"
                        className="flex items-center justify-center gap-2 w-full py-4 bg-white text-black text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-[#ef3333] hover:text-white transition-all shadow-lg active:scale-95"
                      >
            ...
            {isMounted && isAuthenticated && user ? (
              <div className="relative group/profile py-2">
                <Link
                  href="/dashboard"
                  className="flex items-center gap-4 group/avatar"
                >
                ...
                <div className="absolute top-full right-0 w-64 bg-[#111114] border border-zinc-800 shadow-[0_20px_50px_rgba(0,0,0,0.5)] rounded-2xl p-2 opacity-0 translate-y-4 pointer-events-none group-hover/profile:opacity-100 group-hover/profile:translate-y-0 group-hover/profile:pointer-events-auto transition-all duration-300 z-[150]">
                  ...
                  <div className="space-y-1">
                    <Link
                      href="/dashboard"
                      className="flex items-center gap-3 w-full p-3 rounded-xl hover:bg-zinc-900 group/link transition-colors"
                    >
                      <UserIcon
                        size={16}
                        className="text-zinc-600 group-hover/link:text-[#ef3333]"
                      />

                      <span className="text-[11px] font-bold text-zinc-400 group-hover/link:text-white uppercase tracking-widest">
                        Akun Saya
                      </span>
                    </Link>

                    <Link
                      href="/riwayat_pesanan"
                      className="flex items-center gap-3 w-full p-3 rounded-xl hover:bg-zinc-900 group/link transition-colors"
                    >
                      <Package
                        size={16}
                    ...
                    <Link
                      href="/settings"
                      className="flex items-center gap-3 w-full p-3 rounded-xl hover:bg-zinc-900 group/link transition-colors border-t border-zinc-900 pt-3"
                    >
                      <Settings
                        size={16}
                        className="text-zinc-600 group-hover/link:text-[#ef3333]"
                    ...
                    <button
                      onClick={() => logout()}
                      className="flex items-center gap-3 w-full p-3 rounded-xl hover:bg-red-500/10 group/logout transition-colors"
                    >
                      <LogOut
                        size={16}
                        className="text-zinc-600 group-hover/logout:text-[#ef3333]"
                      />

                      <span className="text-[11px] font-bold text-zinc-400 group-hover/logout:text-[#ef3333] uppercase tracking-widest">
                        Sign Out
                      </span>
                    </button>
                  </div>
              ...
              <div className="flex items-center gap-8">
                ...
                <Link
                  href="/auth/register"
                  className="bg-white text-black px-10 py-3.5 rounded-full text-[11px] font-black uppercase tracking-widest hover:bg-[#ef3333] hover:text-white transition-all shadow-xl"
                >
                  Join
                </Link>
              </div>
              ...
              <div className="absolute top-full left-1/2 -translate-x-1/2 w-screen max-w-[1000px] bg-[#111114] border border-zinc-800 shadow-[0_30px_60px_rgba(0,0,0,0.8)] p-8 rounded-b-[3rem] opacity-0 translate-y-4 pointer-events-none group-hover/all:opacity-100 group-hover/all:translate-y-0 group-hover/all:pointer-events-auto transition-all duration-300 z-[110]">
                <div className="grid grid-cols-12 gap-10 text-left">
                      ...
                      <div key={cat.id} className="space-y-4">
                        ...
                        <div className="flex flex-col gap-2">
                          {cat.subCategories?.map((sub: any) => (
                            <Link
                              key={sub.id}
                              href={`/search?sub_category=${sub.id}`}
                  ...
                  <div className="col-span-4 bg-zinc-900/50 rounded-[2rem] p-6 border border-zinc-800 flex flex-col justify-between">
                    ...
                    <button className="w-full py-4 bg-white text-black text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-[#ef3333] hover:text-white transition-all mt-6">
                      Shop now
                    </button>
                  </div>
                </div>
              ...
              {categories.map((cat) => (
                <div key={cat.id} className="relative group/item">
                  <Link
                    ...
                    className="py-4 text-[10px] font-bold text-zinc-500 hover:text-white uppercase tracking-[0.2em] whitespace-nowrap transition-all block border-b-2 border-transparent group-hover/item:border-[#ef3333] group-hover/item:text-white text-center"
                  >
                    {cat.name}
                  </Link>
                  ...
                  <div className="fixed left-0 right-0 top-[auto] mt-0 w-screen bg-[#111114] border-b border-zinc-800 shadow-[0_40px_80px_rgba(0,0,0,0.9)] opacity-0 translate-y-4 pointer-events-none group-hover/item:opacity-100 group-hover/item:translate-y-0 group-hover/item:pointer-events-auto transition-all duration-300 z-[110] px-20 py-12">
                    <div className="max-w-7xl mx-auto grid grid-cols-12 gap-16 text-left">
                      <div className="col-span-3">
                        <h4 className="text-zinc-400 text-[10px] font-black uppercase tracking-[0.2em] mb-6">
                          Top categories
                        </h4>
                      ...
                      <div className="col-span-3">
                        ...
                        <div className="flex flex-col gap-4">
                          ...
                          <Link
                            href="/deals"
                            className="text-sm font-black text-[#ef3333] flex items-center gap-2 mt-4 underline underline-offset-8"
                          >
                      ...
                      <div className="col-span-6 relative rounded-[2.5rem] overflow-hidden group/banner min-h-[300px]">
                        <img
                          src="https://images.unsplash.com/photo-1460723237483-7a6dc9d0b212?q=80&w=1200&auto=format&fit=crop"
                        ...
                        <div className="absolute bottom-10 left-10 right-10 flex justify-between items-end">
                          <div className="space-y-2">
                            <h3 className="text-white text-3xl font-black tracking-tighter leading-none uppercase italic">
                              The Analog
                              <br />
                              Next-Gen
                            </h3>
                            ...
                            <p className="text-zinc-400 text-[10px] font-black uppercase tracking-widest">
                              Limited Edition {cat.name}
                            </p>
                          </div>

                          <button className="bg-white text-black px-8 py-3 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-[#ef3333] hover:text-white transition-all shadow-2xl">
                            Shop now
                          </button>
                        </div>
                      </div>
